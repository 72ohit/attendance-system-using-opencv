...
window.title(" Attendance System Using python ")
...
message = tk.Label(window, text="Attendance System Using Python" ,bg="Green"  ,fg="white"  ,width=50  ,height=3,font=('times', 30, ' bold ')) 

message.place(x=100, y=20) #xy chngd again for fitting it inn centor
...
lbl3 = tk.Label(window, text="Attendance : ",width=10  ,fg="red"  ,bg="yellow"  ,height=2 ,font=('times', 15, ' bold  underline')) 
lbl3.place(x=500, y=600)


message2 = tk.Label(window, text="" ,fg="red"   ,bg="yellow",activeforeground = "green",width=90  ,height=4  ,font=('times', 15, ' bold ')) 
message2.place(x=700, y=600)

lbl = tk.Label(window, text="Group Attendance ",width=20  ,height=2  ,fg="red"  ,bg="yellow" ,font=('times', 15, ' bold ') ) 
...
copyWrite.insert("insert", "Developed by Abhishek Nakate , Samir Wadakar , Ruturaj Tambekar ", "superscript")
copyWrite.configure(state="disabled",fg="red", font=('times', 9,' bold ')  )
copyWrite.pack(side="left")
copyWrite.place(x=10, y=670)
#new buttons
report = tk.Button(window, text="report", command=report  ,fg="red"  ,bg="yellow"  ,width=20  ,height=2 ,activebackground = "Red" ,font=('times', 15, ' bold '))
report.place(x=10, y=400)

clearButton = tk.Button(window, text="Upload", command=picattendance  ,fg="red"  ,bg="yellow"  ,width=20  ,height=1 ,activebackground = "Green" ,font=('times', 15, ' bold '))
clearButton.place(x=10, y=270)
# clearButton = tk.Button(window, text="Todays report", command=clear  ,fg="red"  ,bg="yellow"  ,width=20  ,height=1 ,activebackground = "Green" ,font=('times', 15, ' bold '))
# clearButton.place(x=10, y=250)
window.mainloop()
